...
const generateFlashcards = async (documentId, options) => {
    try {
        ...
        return response.data; // Expecting generated flashcards data
    } catch (error) {
...
const generateQuiz = async (documentId, options) => {
    try {
        ...
        return response.data; // Expecting generated quiz data
    } catch (error) {
...
const generateSummary = async (documentId) => {
    try {
        ...
        return response.data; // Expecting generated summary data
    } catch (error) {
...
const chat = async (documentId, message) => {
    try {
        ...
        return response.data; // Expecting chat response data
    } catch (error) {
...
const explainConcept = async (documentId, concept) => {
    try {
        ...
        return response.data; // Expecting explanation data
    } catch (error) {
...
const getChatHistory = async (documentId) => {
    try {
        ...
        return response.data; // Expecting chat history data
    } catch (error) {
