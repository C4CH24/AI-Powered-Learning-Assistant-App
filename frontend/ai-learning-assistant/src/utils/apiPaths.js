...
export const API_PATHS = {
  ...
  FLASHCARDS: {
    ...
    REVIEW_FLASHCARDS: (cardId) => "/api/flashcards/review",
    TOGGLE_STAR: (cardId) => `/api/flashcards/toggle-star/${cardId}`,
  ...
  QUIZZES: {
    ...
    SUBMIT_QUIZ: (quizId) => `/api/quizzes/submit/${quizId}`,
    GET_QUIZ_RESULTS: (id) => `/api/quizzes/results/${id}`,
